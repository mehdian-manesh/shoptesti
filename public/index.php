...
<body class="main-layout ">
    ...
    <div class="brand">
        ...
        <div id="brands" class="brand-bg">
            <div class="container">
                <div class="row">
                    <?foreach($files as $id => $filename):?>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 margin">
                        <a href="/request.php?order_id=<?php echo $id ?>">
                            <div class="brand_box">
                                <img src="images/<?php echo $id ?>.webp" alt="img" />
                                <div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
                    <div class="about_box"  dir="rtl" style="text-align: right">
                        <h3>در باره ما</h3>
                        <span>بزرگترین فروشگاه آنلاین موبایل در جهان!</span>
                        <p>
                        تجارت الکترونیک اولین بار در سال 1991 توسط تیم برنزلی مطرح شد و 3 سال بعد از آن، یعنی در سال 1994 اولین فروش اینترنتی توسط شرکت پیتزا هات انجام گرفت و با گسترش اینترنت و ارتباطات مجازی این شیوه از فروش هر روزه وسعت بیشتری پیدا کرد و همانطور که مشاهده می کنید تا هم اکنون نیز ادامه دارد.
                        </p>
                        <p>
                            در حال حاظر بزرگترین فروشگاه آنلاین موبایل شاپ تستی است!
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="carousel-inner">
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="cross_inner">
                                    <h3>حمید حمیدی نژاد<br><strong class="ornage_color">اجاره‌ای</strong></h3>
                                    <p>
                                        به نظر من سایت خوبیه
                                    </p>
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="cross_inner">
                                    <h3>حسن حسنی زاده<br><strong class="ornage_color">شرکت حسنان</strong></h3>
                                    <p>حساب من به راحتی به روز شده است</p>
                                    <div class="full text_align_center margin_top_30">
                                        <img src="icon/testimonial_qoute.png">
                                    </div>
                                </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="testomonial_section">
                            ...
                            <div class="full testimonial_cont text_align_center cross_layout">
                                <div class="cross_inner">
                                    <h3>رضا رضاپور<br><strong class="ornage_color">جی‌جی کالا</strong></h3>
                                    <p>
                                        سایت خوبیه
                                    </p>
                                    <div class="full text_align_center margin_top_30">
                    ...
                    <form class="main_form">
                        <div class="row" dir="rtl" style="text-align: right">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" placeholder="نام شما" type="text" name="Your Name">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <input class="form-control" placeholder="آدرس ایمیل" type="text" name="Email">
                            </div>
                            <div class=" col-md-12">
                                <input class="form-control" placeholder="موبایل" type="text" name="Phone">
                            </div>
                            <div class="col-md-12">
                                <textarea class="textarea" placeholder="متن پیام"></textarea>
                            </div>
                            <div class=" col-md-12">
